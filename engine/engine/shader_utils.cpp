...
SplitShader split_shader(const LoadedFile& shader_source, Allocator& allocator)
{
	...
	char* vertex_shader_source = (char*)allocator.allocate(vertex_shader_source_len + 1);
	...
	char* fragment_shader_source = (char*)allocator.allocate(fragment_shader_source_len + 1);
